          ...
          {servicesData.map((service, index) => {
            ...
            return (
              <ScrollReveal key={index} direction="up" delay={index * 0.1}>
                <div className="bg-[#0b101f] border border-gray-800/90 hover:border-cyan-500/40 rounded-3xl p-8 transition-all duration-300 hover:-translate-y-1.5 flex flex-col justify-between shadow-xl group h-full">
                  <div>
