  ...
  return (
    <div className="fixed bottom-6 right-6 z-40 flex flex-col items-end font-sans select-none">
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="mb-3 w-[90vw] sm:w-96 max-w-sm h-[520px] max-h-[80vh] bg-[#0c1324] border border-cyan-500/40 rounded-3xl shadow-2xl flex flex-col overflow-hidden backdrop-blur-xl"
          >
            {/* Window Header */}
            <div className="bg-gradient-to-r from-[#0d1b38] to-[#0c1324] p-4 border-b border-gray-800 flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="w-9 h-9 rounded-xl bg-gradient-to-tr from-cyan-500 to-teal-400 p-[1.5px] shadow-lg shadow-teal-500/20">
                ...
                <div>
                  <div className="flex items-center gap-1.5">
                    <h3 className="text-sm font-bold text-white">ZynTech AI</h3>
            ...
            <div className="flex-1 p-4 overflow-y-auto space-y-3.5 text-xs">
              ...
              {isTyping && (
                <div className="flex items-center gap-2">
                  ...
                  <div className="bg-[#111c33] p-3 rounded-2xl border border-gray-800 flex items-center gap-1.5">
            ...
            {/* Input Form */}
            <div className="p-3 bg-[#0c1324] border-t border-gray-800">
              <div className="flex items-center gap-2 bg-[#070b16] border border-gray-800 focus-within:border-cyan-500/60 rounded-xl px-3 py-2 transition-colors">
                <input
                  ...
                  placeholder="Ask about services, case studies, pricing..."
      ...
      <motion.button
        ...
        className="relative flex items-center gap-2.5 px-4 py-3 rounded-full bg-gradient-to-r from-teal-400 to-cyan-500 text-black font-extrabold text-xs shadow-xl shadow-teal-500/30 transition-all group"
      ...
      >
        ...
        <span className="hidden sm:inline-block font-extrabold text-[11px]">AI Chat Assistant</span>
      </motion.button>
    </div>
  );
}
